...
* 更合适的解码器与更大的模型。[TNT](https://arxiv.org/abs/2008.08294)，[DenseTNT](https://arxiv.org/abs/2108.09640)都是非常有代表性的工作，其他适合用在大语言模型中的解码器结构，比如Transformer, GPT, 也都非常有潜力带来不错的效果。
